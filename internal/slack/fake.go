...
// CreateChannel records the requested name and returns the configured fake channel.
...
// ArchiveChannel records the archived channelID and returns the configured error.
...
// PostMessage records the call and returns the configured timestamp + error.
